"""Per .vmf vertex / index buffer manager for QtPyHammer"""
...
class BufferManager: # links .qph object to VRAM
    # what do we need to render
    # models, solids, displacements
    # keep vertices / indices in RAM until on GPU
    # -- then they're safe to purge
    # how close are we to the limit?
    # hanging onto some data may help (big undos)
    # defragmenting the buffer (minimise draw calls)
