...
##        self.actions["File>Save"].triggered.connect(
        self.actions["File>Save As"] = self.file_menu.addAction('Save &As')
##        self.actions["File>Save As"].triggered.connect(
